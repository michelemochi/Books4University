                ...
                <ul class="summary-items">
                    <li>
                        <div class="summary-title color1">
                            <span> <i class="fa fa-users"></i> Utenti</span>
                        </div>
                        <div class="summary-body color2">${summary.users[0].numUsers}</div>
                    </li>
                    <li>
                        <div class="summary-title color3">
                            <span> <i class="fa fa-users"></i> Ordini</span>
                        </div>
                        <div class="summary-body">${summary.orders[0].numOrders}</div>
                    </li>
                    <li>
                        <div class="summary-title">
                            <span> <i class="fa fa-users"></i> Vendite</span>
                        </div>
